...
class DataQualityProfiler:
    ...
    def _load_data(self) -> pl.DataFrame:
        ...
        try:
            ...
            return df.collect()  # Removed deprecated streaming parameter
    ...
    def _is_date(self, val: Union[str, datetime]) -> bool:
    ...
    def _detect_types(self, series: pl.Series) -> List[str]:
        ...
        return [typ for typ, count in type_counts.items() if count > 0]
    ...
    def _check_inconsistent_data(self, series: pl.Series) -> str:
        ...
        # Empty string check - updated for new Polars API
        if series.dtype == pl.Utf8:
            try:
                ...
                logger.warning(f"Couldn't check empty strings: {str(e)}")
                issues.append("Empty string check failed")
    ...
    def generate_quality_report(self) -> pl.DataFrame:
        ...
        return pl.DataFrame(report_rows).select([
            "Column Name", "Data Type", "Mixed Types", "Type Count",
